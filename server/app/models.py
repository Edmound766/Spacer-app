...
class Role(db.Model, SerializerMixin):
    ...
    users: Mapped[list["User"]] = relationship(secondary=user_roles, back_populates='role')
    ...
    def availability(self):
        ...
        for booking in self.bookings:
            ...
            if booking.status == BookingStatus.UPCOMING:
                payment_pending = booking.payment and booking.payment.status == PaymentStatus.PENDING
